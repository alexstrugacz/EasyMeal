...
const NutritionMadeEasy: React.FC<{}> = () => {
    return <div className="w-full h-full pt-8 bg-white">
        ...
        <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink hover:scale-105 transition-all">
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div className="flex-1 bg-white rounded-2xl overflow-hidden shadow hover:scale-105 transition-all">
                    <div className="flex flex-wrap no-underline hover:no-underline">
